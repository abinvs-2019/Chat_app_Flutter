...
class RecievingCallPage extends StatefulWidget {
  ...
  const RecievingCallPage({Key key, this.channelName, this.role})
      : super(key: key);

  @override
  _RecievCallPageState createState() => _RecievCallPageState();
}

class _RecievCallPageState extends State<RecievingCallPage> {
  final _users = <int>[];
